...
<script>
    ...
    var tableName = "dictionaryRudangshenqingYesno";
    ...
    function submit() {
        if (validform() == true && compare() == true) {
            ...
            data["dicCode"] = "rudangshenqing_yesno_types";
            data["dicName"] = "新闻类型";
    ...
    function getDetails() {
        ...
        if (adddictionary != null && adddictionary != "" && adddictionary != "null") {
            ...
            $(validform());
            $('#submitBtn').text('新增');
            httpJson("dictionary/maxCodeIndex" , "POST", {"dicCode":"rudangshenqing_yesno_types"}, (res) => {
                if(res.code == 0){
