...
<!--/Pre Loader -->
    ...
    <script>
        ...
        function setDataRow(item, number) {
            ...
            else if(item.dangwurenyuanId != null){
                shenfenCell.innerHTML = '党务人员';
            }
            ...
            if(false){}
                ...
                xingmingCell.innerHTML = item.dangwurenyuanName;
            }
                else if(item.usersId != null){
            ...
            if(false){}
                ...
                phoneCell.innerHTML = item.dangwurenyuanPhone;
            }
            else if(item.usersId != null){
            ...
            if(
                ...
                false
                    ...
                    || (window.sessionStorage.getItem('role') == "党务人员" && item.dangwurenyuanId == window.sessionStorage.getItem('userId'))
