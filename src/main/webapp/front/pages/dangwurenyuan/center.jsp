    ...
    <ul id="category">
				...
				<div class="right-container">
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="dangwurenyuanName" id="dangwurenyuanName" lay-verify="required" placeholder="党务人员姓名" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="dangwurenyuanPhone" id="dangwurenyuanPhone"  lay-verify="required|phone"   placeholder="党务人员手机号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="dangwurenyuanPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="dangwurenyuanPhoto" name="dangwurenyuanPhoto"/>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="dangwurenyuanEmail" id="dangwurenyuanEmail"  lay-verify="required|email"   placeholder="电子邮箱" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`dangwurenyuan/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#dangwurenyuanPhotoImg").attr("src", data.data.dangwurenyuanPhoto);
                });
