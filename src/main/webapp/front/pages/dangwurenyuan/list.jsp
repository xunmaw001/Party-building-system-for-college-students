                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="dangwurenyuanName" id="dangwurenyuanName" placeholder="党务人员姓名" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        function pageList() {
            ...
            if (jquery('#dangwurenyuanName').val() != null && jquery('#dangwurenyuanName').val() != "" && jquery('#dangwurenyuanName').val() != "null" ) {
                param['dangwurenyuanName'] = jquery('#dangwurenyuanName').val();
            }
                                        

            // 获取列表数据
            http.request('dangwurenyuan/list', 'get', param, function(res) {
