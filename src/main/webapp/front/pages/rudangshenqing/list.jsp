            ...
            <div class="ng-inmod-ini">
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">入党申请标题</label>
                          <div class="layui-input-inline">
                              <input type="text" name="rudangshenqingName" id="rudangshenqingName" placeholder="入党申请标题" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <select name="rudangshenqingYesnoTypes" id="rudangshenqingYesnoTypes" lay-filter="rudangshenqingYesnoTypes">
                                  <option value="">--请选择--</option>
                                  <option v-for="item in rudangshenqingYesnoTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                              </select>
                          </div>
                      </div>
...
<script>
    var vue = new Vue({
        ...
        data: {
            ...
            dataList: [],//数据
        // 当前表字典表数据
            rudangshenqingYesnoTypesList : [],
            rudangshenqingTypes: 0,//类型
            limit: 8,
    ...
    // 当前表的字典表
        ...
        function rudangshenqingYesnoTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=rudangshenqing_yesno_types", 'get', {}, function (res) {
                if(res.code == 0){
                    vue.rudangshenqingYesnoTypesList = res.data.list;
                }
            });
        }
        ...
        function pageList() {
            ...
            if (jquery('#rudangshenqingName').val() != null && jquery('#rudangshenqingName').val() != "" && jquery('#rudangshenqingName').val() != "null" ) {
                param['rudangshenqingName'] = jquery('#rudangshenqingName').val();
            }
                         
            var rudangshenqingYesnoTypes = $("#rudangshenqingYesnoTypes").find("option:selected").val();
            if (rudangshenqingYesnoTypes != null && rudangshenqingYesnoTypes != "" && rudangshenqingYesnoTypes != "null") {
                param['rudangshenqingYesnoTypes'] = rudangshenqingYesnoTypes;
            }
                        

            // 获取列表数据
            http.request('rudangshenqing/list', 'get', param, function(res) {
