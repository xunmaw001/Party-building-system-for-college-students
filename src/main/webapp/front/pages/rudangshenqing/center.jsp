    ...
    <ul id="category">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="rudangshenqingName" id="rudangshenqingName" lay-verify="required" placeholder="入党申请标题" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="rudangshenqingYesnoTypes" id="rudangshenqingYesnoTypes">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="rudangshenqingYesnoText" id="rudangshenqingYesnoText" lay-verify="required" placeholder="审核意见" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="rudangshenqingShenheTime" id="rudangshenqingShenheTime"  lay-verify="required|date"   placeholder="审核时间" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`rudangshenqing/session`, 'get', {}, function (data) {
                    // 表单赋值
			   ...
			   function rudangshenqingYesnoTypesSelect() {
				   //填充下拉框选项
				   http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=rudangshenqing_yesno_types", "GET", {}, (res) => {
					   if(res.code == 0){
