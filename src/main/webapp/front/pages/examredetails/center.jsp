    ...
    <ul id="category">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="examredetailsUuidNumber" id="examredetailsUuidNumber" lay-verify="required" placeholder="试卷编号" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="examredetailsMyanswer" id="examredetailsMyanswer" lay-verify="required" placeholder="考生答案" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="examredetailsMyscore" id="examredetailsMyscore"  lay-verify="required|integer"   placeholder="试题得分" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`examredetails/session`, 'get', {}, function (data) {
                    // 表单赋值
