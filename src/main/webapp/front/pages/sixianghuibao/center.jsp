    ...
    <ul id="category">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="sixianghuibaoName" id="sixianghuibaoName" lay-verify="required" placeholder="汇报标题" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							<div class="layui-input-block">
								<img id="sixianghuibaoPhotoImg"
									 ...
									 src="../../img/avator.png">
								<input type="hidden" id="sixianghuibaoPhoto" name="sixianghuibaoPhoto"/>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="sixianghuibaoTypes" id="sixianghuibaoTypes">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="sixianghuibaoClicknum" id="sixianghuibaoClicknum"  lay-verify="required|integer"   placeholder="热度" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`sixianghuibao/session`, 'get', {}, function (data) {
                    // 表单赋值
                    form.val("myForm", data.data);
					jquery("#sixianghuibaoPhotoImg").attr("src", data.data.sixianghuibaoPhoto);
                });
