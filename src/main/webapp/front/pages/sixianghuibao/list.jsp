            ...
            <div class="ng-inmod-ini">
                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <label class="layui-form-label">汇报标题</label>
                          <div class="layui-input-inline">
                              <input type="text" name="sixianghuibaoName" id="sixianghuibaoName" placeholder="汇报标题" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <select name="sixianghuibaoTypes" id="sixianghuibaoTypes" lay-filter="sixianghuibaoTypes">
                                  <option value="">--请选择--</option>
                                  <option v-for="item in sixianghuibaoTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
                              </select>
                          </div>
                      </div>
                    ...
                    <section style="margin: 10px">
                        <div class="row">
                            <div v-for="(item,index) in dataList" class="col-md-3">
                                <div class="gallery-demo" @click="jumpCheck('../sixianghuibao/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                    <img :src="item.sixianghuibaoPhoto?item.sixianghuibaoPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                    <h4 class="p-mask">{{item.sixianghuibaoName}}
                                        <span v-if="item.sixianghuibaoNewMoney"> - ￥{{item.sixianghuibaoNewMoney}}</span>
                                        <span v-else> - {{item.sixianghuibaoValue}}</span>
                                    </h4>
                                </div>
                            </div>
                        </div>
...
<script>
    var vue = new Vue({
        ...
        data: {
            ...
            dataList: [],//数据
        // 当前表字典表数据
            sixianghuibaoTypesList : [],
            sixianghuibaoTypes: 0,//类型
            limit: 8,
    ...
    // 当前表的字典表
        ...
        function sixianghuibaoTypesSelect() {
            http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=sixianghuibao_types", 'get', {}, function (res) {
                if(res.code == 0){
                    vue.sixianghuibaoTypesList = res.data.list;
                }
            });
        }
        ...
        function pageList() {
            ...
            if (jquery('#sixianghuibaoName').val() != null && jquery('#sixianghuibaoName').val() != "" && jquery('#sixianghuibaoName').val() != "null" ) {
                param['sixianghuibaoName'] = jquery('#sixianghuibaoName').val();
            }
                 
            var sixianghuibaoTypes = $("#sixianghuibaoTypes").find("option:selected").val();
            if (sixianghuibaoTypes != null && sixianghuibaoTypes != "" && sixianghuibaoTypes != "null") {
                param['sixianghuibaoTypes'] = sixianghuibaoTypes;
            }
                                

            // 获取列表数据
            http.request('sixianghuibao/list', 'get', param, function(res) {
