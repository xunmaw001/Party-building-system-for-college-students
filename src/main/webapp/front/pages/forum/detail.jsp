...
<body>
    ...
    <div id="app">
        ...
        <div v-if="detail.dangwurenyuanId" class="auth-container">
            发布人{{detail.dangwurenyuanName}}&nbsp;&nbsp;&nbsp;发布人权限：党务人员&nbsp;&nbsp;&nbsp;时间：{{detail.insertTime}}
        </div>
            ...
            <div class="message-list">
                <div class="message-item" v-for="(item,index) in dataList" v-bind:key="index">
                    ...
                    <div v-if="item.yonghuId" class="username-container">
                        ...
                        <span class="username">学生：{{item.yonghuName}}</span>
                    </div>
                    <div v-if="item.dangwurenyuanId" class="username-container">
                        <img class="avator" :src="item.dangwurenyuanPhoto">
                        <span class="username">党务人员：{{item.dangwurenyuanName}}</span>
                    </div>
