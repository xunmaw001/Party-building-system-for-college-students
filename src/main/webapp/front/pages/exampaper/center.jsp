    ...
    <ul id="category">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="exampaperName" id="exampaperName" lay-verify="required" placeholder="试卷名称" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="exampaperDate" id="exampaperDate"  lay-verify="required|integer"   placeholder="考试时长(分钟)" autocomplete="off" class="layui-input">
							</div>
						</div>

						<div class="layui-form-item">
							<label class="layui-form-label">试卷总分数</label>
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="exampaperMyscore" id="exampaperMyscore"  lay-verify="required|integer"   placeholder="试卷总分数" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="exampaperTypes" id="exampaperTypes">
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`exampaper/session`, 'get', {}, function (data) {
                    // 表单赋值
			   ...
			   function exampaperTypesSelect() {
				   //填充下拉框选项
				   http.request("dictionary/page?page=1&limit=100&sort=&order=&dicCode=exampaper_types", "GET", {}, (res) => {
					   if(res.code == 0){
