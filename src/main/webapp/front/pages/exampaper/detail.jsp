        ...
        <section class="blog-details-section pt-120 pb-120">
            <div class="data-detail-breadcrumb" style="width: 1110px; padding: 0px 10px; box-shadow: rgba(255, 0, 0, 0.3) 0px 0px 0px; margin: 20px auto; border-color: rgb(135, 206, 250); border-radius: 4px; border-width: 0px; border-style: solid; height: 54px;">
                <span class="layui-breadcrumb">
                    ...
                    <a><cite>{{detail.exampaperName}}</cite></a>
                </span>
        ...
        <div class="row">
            <div class="col-lg-8">
                <div class="blog-details-wrapper">
                    <div><img :src="detail.exampaperPhoto" alt="image" style="width: 80%;height: auto" ></div>
            ...
            <div class="sidebar">
                ...
                <div class="widget">
                    ...
                    <ul class="small-post-list">
                        <li class="small-post-single" v-for="(item,index) in exampaperRecommendList" v-bind:key="index" @click="jump('../exampaper/detail.jsp?id='+item.id)">
                            <div class="thumb"><img width="65px" :src="item.exampaperPhoto"  alt="image"></div>
                            <div class="content">
                                <a class="main_color" class="date">{{item.exampaperName}}</a>
                                <h6 v-if="item.exampaperNewMoney" class="post-title"><a style="color: red">{{item.exampaperNewMoney}}</a>RMB</h6>
                            </div>
                        </li>
                    </ul>
                </div>
