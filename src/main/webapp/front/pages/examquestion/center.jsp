    ...
    <ul id="category">
					...
					<form class="layui-form" lay-filter="myForm">
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="examquestionName" id="examquestionName" lay-verify="required" placeholder="试题名称" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="examquestionOptions" id="examquestionOptions" lay-verify="required" placeholder="选项，json字符串" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="examquestionScore" id="examquestionScore"  lay-verify="required|integer"   placeholder="分值" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="examquestionAnswer" id="examquestionAnswer" lay-verify="required" placeholder="正确答案" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="examquestionAnalysis" id="examquestionAnalysis" lay-verify="required" placeholder="答案解析" autocomplete="off" class="layui-input">
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div  class="layui-input-inline" style="width: 500px">
								<select name="examquestionTypes" id="examquestionTypes">
                                    <option v-for="item in examquestionTypesList" :value="item.codeIndex" :key="item.codeIndex">{{ item.indexName }}</option>
								</select>
							</div>
						</div>
						...
						<div class="layui-form-item">
							...
							<div class="layui-input-block">
								<input type="text" style="width: 500px" name="examquestionSequence" id="examquestionSequence"  lay-verify="required|integer"   placeholder="试题排序，值越大排越前面" autocomplete="off" class="layui-input">
							</div>
						</div>
		...
		<script>
            ...
            layui.use(['layer', 'element', 'carousel', 'http', 'jquery', 'form', 'upload', 'laydate'], function () {
                ...
                http.request(`examquestion/session`, 'get', {}, function (data) {
                    // 表单赋值
