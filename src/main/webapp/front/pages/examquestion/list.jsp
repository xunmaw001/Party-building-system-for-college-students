                    ...
                    <form class="layui-form" lay-filter="myForm">
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="examquestionName" id="examquestionName" placeholder="试题名称" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      ...
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          ...
                          <div class="layui-input-inline">
                              <input type="text" name="examquestionScoreStart" id="examquestionScoreStart"  lay-skin="integer"   placeholder="分值开始" autocomplete="off" class="layui-input">
                          </div>
                      </div>
                      <div class="layui-inline" style="margin-bottom: 10px;">
                          <div class="layui-input-inline" style="margin-top: -5px">
                              <input type="text" name="examquestionScoreEnd"   id="examquestionScoreEnd"    lay-skin="integer|examquestionScoreEnd"   placeholder="分值结束" autocomplete="off" class="layui-input">
                          </div>
                      </div>
...
<script>
    ...
    // 当前表的字典表
        ...
        form.verify({
            ...
            ,examquestionScoreEnd: function(value, item){ //value：表单的值、item：表单的DOM对象
                    var examquestionScoreStart = $("#examquestionScoreStart").val();
                 if(examquestionScoreStart != null && examquestionScoreStart != "" && examquestionScoreStart != "null"){
                    var number = parseInt(value)- parseInt(examquestionScoreStart);
                    if(number<0){
                        return '分值的结束值不能小于开始值';
                    }
                 }
            }
        ...
        function pageList() {
            ...
            if (jquery('#examquestionName').val() != null && jquery('#examquestionName').val() != "" && jquery('#examquestionName').val() != "null" ) {
                param['examquestionName'] = jquery('#examquestionName').val();
            }
                 
            if (jquery('#examquestionScoreStart').val() != null && jquery('#examquestionScoreStart').val() != "" && jquery('#examquestionScoreStart').val() != "null" ) {
                param['examquestionScoreStart'] = jquery('#examquestionScoreStart').val();
            }
            if (jquery('#examquestionScoreEnd').val() != null && jquery('#examquestionScoreEnd').val() != "" && jquery('#examquestionScoreEnd').val() != "null" ) {
                param['examquestionScoreEnd'] = jquery('#examquestionScoreEnd').val();
            }
