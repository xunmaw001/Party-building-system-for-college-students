        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="gallery">
                        <div class="row">
                            <div class="col-md-3" v-for="(item,index) in newsList" >
                                <div class="galry-grid grid-top-rgt">
                                    <a href="javascript:return false;"  @click="jumpCheck('../news/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                        <img class="img-responsive zoom-img" :src="item.newsPhoto?item.newsPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                        <div class="w3agile-text">
                                            <h5>
                                                <span>{{item.newsName}}</span>
                                                <br/>
                                                <span v-if="item.newsNewMoney">
        ...
        <div class="ng-inmod ng-fault ng-paddor ng-bg-assist">
            <div class="ng-inmod-ini">
                ...
                <div class="ng-incontlst ng-fault ng-container ng-ai-drive1_map" aos="fade-up">
                    <div class="gallery">
                        <div class="row">
                            <div class="col-md-3" v-for="(item,index) in sixianghuibaoList" >
                                <div class="galry-grid grid-top-rgt">
                                    <a href="javascript:return false;"  @click="jumpCheck('../sixianghuibao/detail.jsp?id='+item.id , item.aaaaaaaaaa == null?'':item.aaaaaaaaaa , item.shangxiaTypes == null?'':item.shangxiaTypes)">
                                        <img class="img-responsive zoom-img" :src="item.sixianghuibaoPhoto?item.sixianghuibaoPhoto.split(',')[0]:''" style="height: 350px;width:100%;"/>
                                        <div class="w3agile-text">
                                            <h5>
                                                <span>{{item.sixianghuibaoName}}</span>
                                                <br/>
                                                <span v-if="item.sixianghuibaoNewMoney">
                                                    {{item.sixianghuibaoNewMoney}} RMB
                                                </span>
                                                <span v-else>
                                                    {{item.sixianghuibaoValue}}
                                                </span>
                                            </h5>
...
<script>
    ...
    layui.use(['layer', 'form', 'element', 'carousel', 'http', 'jquery'], function () {
        ...
        http.request(`sixianghuibao/list`, 'get', {
            ...
            vue.sixianghuibaoList = res.data.list;
        });
    });
</script>
