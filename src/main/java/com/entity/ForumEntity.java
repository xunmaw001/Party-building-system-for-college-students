...
public class ForumEntity<T> implements Serializable {
     ...
     * 党务人员
     */
    @TableField(value = "dangwurenyuan_id")

    private Integer dangwurenyuanId;
	 ...
	 * 设置：党务人员
	 */
    public Integer getDangwurenyuanId() {
        return dangwurenyuanId;
    }
    /**
	 * 获取：党务人员
	 */

    public void setDangwurenyuanId(Integer dangwurenyuanId) {
        this.dangwurenyuanId = dangwurenyuanId;
    }
    /**
	 * 设置：管理员
	 */
    ...
    public String toString() {
        return "Forum{" +
            ...
            ", forumName=" + forumName +
            ", yonghuId=" + yonghuId +
            ", dangwurenyuanId=" + dangwurenyuanId +
            ", usersId=" + usersId +
