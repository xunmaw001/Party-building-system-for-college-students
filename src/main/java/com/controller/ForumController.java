    ...
    public R info(@PathVariable("id") Long id, HttpServletRequest request){
        ...
        if(forum !=null){
            ...
            BeanUtils.copyProperties( forum , view );//把实体数据重构到view中
                ...
                //级联表
                DangwurenyuanEntity dangwurenyuan = dangwurenyuanService.selectById(forum.getDangwurenyuanId());
                if(dangwurenyuan != null){
                    BeanUtils.copyProperties( dangwurenyuan , view ,new String[]{ "id", "createTime", "insertTime", "updateTime"});//把级联的数据添加到view中,并排除id和创建时间字段
                    view.setDangwurenyuanId(dangwurenyuan.getId());
                }
    ...
    */
    ...
    public R save(@RequestBody ForumEntity forum, HttpServletRequest request){
        ...
        if(false)
            ...
            forum.setDangwurenyuanId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<ForumEntity> queryWrapper = new EntityWrapper<ForumEntity>()
            ...
            .eq("dangwurenyuan_id", forum.getDangwurenyuanId())
...
//                            forumEntity.setDangwurenyuanId(Integer.valueOf(data.get(0)));   //党务人员 要改的
        ...
        ForumEntity forum = forumService.selectById(id);
            if(forum !=null){
                ...
                //级联表
                    DangwurenyuanEntity dangwurenyuan = dangwurenyuanService.selectById(forum.getDangwurenyuanId());
                if(dangwurenyuan != null){
                    BeanUtils.copyProperties( dangwurenyuan , view ,new String[]{ "id", "createDate"});//把级联的数据添加到view中,并排除id和创建时间字段
                    view.setDangwurenyuanId(dangwurenyuan.getId());
                }
                    UsersEntity users = usersService.selectById(forum.getUsersId());
                if(users != null){
